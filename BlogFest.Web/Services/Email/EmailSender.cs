...
namespace BlogFest.Web.Services.Email
{
    public class EmailSender : IEmailSender
    {
        ...
        public async Task SendEmailAsync(string toEmail, string subject, string message)
        {
            ...
            if (string.IsNullOrEmpty(Options.SenderEmail)) throw new Exception("Null Email");
            if (string.IsNullOrEmpty(Options.SenderName)) throw new Exception("Null SenderName");
